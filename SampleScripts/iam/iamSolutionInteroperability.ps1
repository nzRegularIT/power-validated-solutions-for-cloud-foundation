...
Write-LogMessage -Type INFO -Message "Starting the Process of Configuring Solution Interoperability for Identity and Access Management for VMware Cloud Foundation" -Colour Yellow
